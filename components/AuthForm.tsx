...
const AuthForm = ({ type }: AuthFormProps) => {
  ...
  const [user, setUser] = useState<DemoAuthProfile | null>(null);
  ...
  return (
    <section className="auth-form">
        ...
        <div className="flex flex-col gap-1 md:gap-3">
          <h1 className="text-24 lg:text-36 font-semibold text-gray-900">
            ...
            <p className="text-16 font-normal text-gray-600">
              {user
                ? "Connect a horizon bank to unlock the full dashboard"
                : type === "sign-in"
                  ? "Access the private horizon in seconds"
                  : "Set up your horizon profile and get started"}
            </p>
          </h1>
        </div>
      </header>
      {user ? (
        ...
        <>
          {type === "sign-in" && (
            <div className="rounded-2xl border border-blue-100 bg-blue-25 p-4">
